...
const Description = ({ fullDesc, shortDesc }) => {
  ...
  return (
    <Fragment>
      ...
      <button onClick={() => setDescShown(!descShown)} className={btnStyle}>{descShown ? 'Hide' : 'Show more'}</button>
    </Fragment>
  )
}
  ...
  return (
    <div className={styles["grid-container"]}>
      ...
      <div className={styles["desc-area"]}>
        ...
        <Description fullDesc={product.full_desc} shortDesc={product.short_desc} />
